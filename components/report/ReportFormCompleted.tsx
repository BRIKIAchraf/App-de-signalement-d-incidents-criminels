...
export function ReportSubmitted({ data }: ReportFormCompletedProps) {
  const reportId = data.reportId || "ERROR-ID-NOT-FOUND";
  return (
    <div className="flex-center space-y-6">
      <div className="flex flex-col items-center">
        <div className="bg-green-500/10 rouded-full p-3">
          <svg
        ...
        <h3 className="mt4 text-xl font-medium text-white">
